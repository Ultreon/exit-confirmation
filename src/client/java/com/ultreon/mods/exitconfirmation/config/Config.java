...
public class Config {
    ...
    public final ConfigEntry<Boolean> solidBackgroumd;
    ...
    public Config() {
        ...
        this.solidBackgroumd = this.add("screen.forceSolidBackground", false, "Make the background of the close prompt always solid.");
